...
RUN apk add --no-cache -U zeromq-dev postgresql-libs gcc g++ musl-dev postgresql-dev curl libnfs-dev nfs-utils libffi-dev
RUN addgroup -S bolt
...
COPY ../bolt-locust-clients-0.2.tar.gz /home/bolt
